  ...
  <section>
    <div class="cadastro">
      ...
      <div id="cadastro-texto">
        <h2 id="cadastro-titulo">CADASTRO DE LIVROS</h2>
        <p id="cadastro-description">Cadastro de livros públicos</p>
        <form enctype="multipart/form-data" id="cadastro-form" action="saveAcervo.php" method="POST">
          ...
          <input class="input" type="file" id="arquivo" name="arquivo"><br>
